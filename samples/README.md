...
| `novelgame` | branching Japanese VN story with 3 workers | `cargo run -p wmfrontend --bin wmfrontend -- samples/novelgame` | `cargo run -p wmfrontend --bin wmautoui -- .test-novelgame/novelgame.warc --platform egui --choice sea --expect ending-fog-harbor` | `cargo run -p wmtoolchain --bin wmtoolchain -- samples/novelgame/main.wms --package novelgame --platform egui --middleware samples/novelgame/middleware.wms --background samples/novelgame/background.wms --image ui/background=samples/novelgame/background.png --out .test-novelgame/novelgame.warc` |
...
cargo run -p wmtoolchain --bin wmtoolchain -- samples/novelgame/main.wms --package novelgame --platform egui --middleware samples/novelgame/middleware.wms --background samples/novelgame/background.wms --image ui/background=samples/novelgame/background.png --out .test-novelgame/novelgame.warc
