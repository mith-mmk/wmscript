...
use wmlhost::{CapabilityMask, HostId, HostRegistry};
...
mod tests {
    ...
    fn vm_stores_configuration() {
        ...
        assert_eq!(vm.config().platform.kind, wmlplatform::PlatformKind::Native);
    ...
    fn vm_calls_host_functions() {
        ...
        registry.register(wmlhost::HostFunction::new(7, 1, 1, 0));
