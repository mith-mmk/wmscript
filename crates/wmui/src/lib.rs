...
pub struct UiMessageWindowStyle {
    ...
    pub choice_panel_fill: UiColorRgba,
    pub choice_panel_stroke: UiColorRgba,
    pub choice_text_color: UiColorRgba,
    pub choice_accent_color: UiColorRgba,
    pub choice_selected_fill: UiColorRgba,
    pub choice_selected_stroke: UiColorRgba,
    pub input_panel_fill: UiColorRgba,
    pub input_panel_stroke: UiColorRgba,
    pub input_text_color: UiColorRgba,
    pub input_hint_color: UiColorRgba,
    pub input_prompt_color: UiColorRgba,
...
impl Default for UiMessageWindowStyle {
    fn default() -> Self {
        Self {
            ...
            choice_panel_fill: UiColorRgba::new(8, 14, 26, 226),
            choice_panel_stroke: UiColorRgba::new(92, 180, 214, 224),
            choice_text_color: UiColorRgba::new(238, 246, 255, 255),
            choice_accent_color: UiColorRgba::new(138, 220, 246, 255),
            choice_selected_fill: UiColorRgba::new(24, 64, 92, 196),
            choice_selected_stroke: UiColorRgba::new(150, 230, 255, 228),
            input_panel_fill: UiColorRgba::new(8, 14, 24, 224),
            input_panel_stroke: UiColorRgba::new(180, 220, 180, 180),
            input_text_color: UiColorRgba::new(244, 250, 255, 255),
            input_hint_color: UiColorRgba::new(168, 186, 204, 220),
            input_prompt_color: UiColorRgba::new(180, 220, 180, 255),
            body_font_size: 18.0,
